...
permalink: "/cheatsheet/ewpt/09-tools-reference/scripting-snippets/"
...
**Time to Master:** 1.5h
**Prerequisiti:** [Command-Line-Tools.md](/cheatsheet/ewpt/09-tools-reference/command-line-tools/)
...
- **Prerequisito:** [Command-Line-Tools.md](/cheatsheet/ewpt/09-tools-reference/command-line-tools/)
- **Combinazione con:** [04-SQL-Injection/04-Blind-SQLi.md](/cheatsheet/ewpt/04-sql-injection/04-blind-sqli/)
