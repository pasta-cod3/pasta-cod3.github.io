...
permalink: "/cheatsheet/ewpt/09-tools-reference/automation-scripts/"
...
**Time to Master:** 1.5h
**Prerequisiti:** [Scripting-Snippets.md](/cheatsheet/ewpt/09-tools-reference/scripting-snippets/)
...
**Spiegazione:** utile per raccogliere una serie di misurazioni timing (vedi [07-Business-Logic/04-Timing-Attacks.md](/cheatsheet/ewpt/07-business-logic/04-timing-attacks/)) e calcolarne la mediana.
...
- **Prerequisito:** [Scripting-Snippets.md](/cheatsheet/ewpt/09-tools-reference/scripting-snippets/)
- **Combinazione con:** [04-SQL-Injection/07-SQLMap-Automation.md](/cheatsheet/ewpt/04-sql-injection/07-sqlmap-automation/)
