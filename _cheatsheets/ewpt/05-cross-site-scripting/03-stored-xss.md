...
cert_label: "eWPT"
title: "Stored XSS"
permalink: "/cheatsheet/ewpt/05-cross-site-scripting/03-stored-xss/"
...
**Time to Master:** 1.5h
**Prerequisiti:** [02-Reflected-XSS.md](/cheatsheet/ewpt/05-cross-site-scripting/02-reflected-xss/)
...
Vedi [06-WAF-Evasion.md](/cheatsheet/ewpt/05-cross-site-scripting/06-waf-evasion/) per bypass generali; per stored XSS in particolare, verifica sempre se la sanitizzazione avviene solo in input (al salvataggio) o anche in output (alla visualizzazione): a volte solo una delle due è implementata.
...
- **Prerequisito:** [02-Reflected-XSS.md](/cheatsheet/ewpt/05-cross-site-scripting/02-reflected-xss/)
- **Prossimo Step:** [04-DOM-XSS.md](/cheatsheet/ewpt/05-cross-site-scripting/04-dom-xss/)
- **Combinazione con:** [07-Cookie-Stealing.md](/cheatsheet/ewpt/05-cross-site-scripting/07-cookie-stealing/)
