...
cert: ewpt
cert_label: "eWPT"
title: "Encoding Payloads (XSS)"
permalink: "/cheatsheet/ewpt/05-cross-site-scripting/05-encoding-payloads/"
...
**Difficoltà:** Advanced
**Time to Master:** 1.5h
**Prerequisiti:** [04-DOM-XSS.md](/cheatsheet/ewpt/05-cross-site-scripting/04-dom-xss/)
...
Questo intero file è la sezione evasion basata su encoding. Combina sempre encoding + tag/handler alternativi (vedi [06-WAF-Evasion.md](/cheatsheet/ewpt/05-cross-site-scripting/06-waf-evasion/)) per massimizzare le probabilità di bypass.
...
- **Prerequisito:** [04-DOM-XSS.md](/cheatsheet/ewpt/05-cross-site-scripting/04-dom-xss/)
- **Prossimo Step:** [06-WAF-Evasion.md](/cheatsheet/ewpt/05-cross-site-scripting/06-waf-evasion/)
