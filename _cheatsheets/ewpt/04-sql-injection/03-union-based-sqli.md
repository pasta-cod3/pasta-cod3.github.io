...
permalink: "/cheatsheet/ewpt/04-sql-injection/03-union-based-sqli/"
...
**Time to Master:** 2.5h
**Prerequisiti:** [02-Error-Based-SQLi.md](/cheatsheet/ewpt/04-sql-injection/02-error-based-sqli/)
...
| sqlmap | `--technique=U --dump` | automatizza extraction | vedi [07-SQLMap-Automation.md](/cheatsheet/ewpt/04-sql-injection/07-sqlmap-automation/) |
...
- **Prerequisito:** [02-Error-Based-SQLi.md](/cheatsheet/ewpt/04-sql-injection/02-error-based-sqli/)
- **Prossimo Step:** [04-Blind-SQLi.md](/cheatsheet/ewpt/04-sql-injection/04-blind-sqli/)
