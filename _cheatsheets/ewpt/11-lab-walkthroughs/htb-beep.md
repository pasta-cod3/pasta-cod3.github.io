...
cert: ewpt
cert_label: "eWPT"
title: "HTB: Beep (Walkthrough Notes)"
permalink: "/cheatsheet/ewpt/11-lab-walkthroughs/htb-beep/"
...
```
Cerca in particolare LFI note nel pannello (es. tramite parametro che include file di log/config), applicabile secondo la metodologia di [03-File-Inclusion/01-LFI-Basics.md](/cheatsheet/ewpt/03-file-inclusion/01-lfi-basics/).

### 4. Da LFI a RCE
Vettore tipico su Elastix: log poisoning del log di Asterisk (es. `/var/log/asterisk/full`), che registra header SIP (come lo User-Agent) senza sanitizzazione: inserisci un payload PHP in quell'header e poi includilo tramite la LFI. Applica la metodologia di [03-File-Inclusion/02-LFI-Advanced.md](/cheatsheet/ewpt/03-file-inclusion/02-lfi-advanced/).
...
- **Combinazione con:** [03-File-Inclusion/02-LFI-Advanced.md](/cheatsheet/ewpt/03-file-inclusion/02-lfi-advanced/), [02-Scanning-Enumeration/02-Service-Detection.md](/cheatsheet/ewpt/02-scanning-enumeration/02-service-detection/)
