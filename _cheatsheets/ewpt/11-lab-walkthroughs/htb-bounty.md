...
cert: ewpt
cert_label: "eWPT"
title: "HTB: Bounty (Walkthrough Notes)"
permalink: "/cheatsheet/ewpt/11-lab-walkthroughs/htb-bounty/"
...
Se `.aspx`/`.asp` sono bloccati, prova estensioni alternative eseguibili da IIS legacy come `.config` (vedi [08-Exploitation-PostEx/01-File-Upload-Abuse.md](/cheatsheet/ewpt/08-exploitation-postex/01-file-upload-abuse/)):
```
...
- Le blacklist di estensione IIS vanno testate sistematicamente con l'intera lista di [01-File-Upload-Abuse.md](/cheatsheet/ewpt/08-exploitation-postex/01-file-upload-abuse/)
