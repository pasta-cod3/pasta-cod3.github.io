...
permalink: "/cheatsheet/ewpt/00-fundamentals/http-https-deep-dive/"
...
**Difficoltà:** Beginner
**Time to Master:** 4h
**Prerequisiti:** [Networking-Basics.md](/cheatsheet/ewpt/00-fundamentals/networking-basics/)
...
| Burp Proxy | intercept ON | intercetta traffico browser | vedi [Burp-Suite-Setup.md](/cheatsheet/ewpt/00-fundamentals/burp-suite-setup/) |
...
- **Prerequisito:** [Networking-Basics.md](/cheatsheet/ewpt/00-fundamentals/networking-basics/)
- **Prossimo Step:** [Linux-for-WebHacking.md](/cheatsheet/ewpt/00-fundamentals/linux-for-webhacking/)
- **Combinazione con:** [06-Authentication-Authorization/01-Session-Management.md](/cheatsheet/ewpt/06-authentication-authorization/01-session-management/)
