...
cert: ewpt
cert_label: "eWPT"
title: "RFI Techniques"
permalink: "/cheatsheet/ewpt/03-file-inclusion/03-rfi-techniques/"
...
**Difficoltà:** Advanced
**Time to Master:** 1.5h
**Prerequisiti:** [02-LFI-Advanced.md](/cheatsheet/ewpt/03-file-inclusion/02-lfi-advanced/)
...
Senza `allow_url_include=On` la RFI classica non funziona: verifica sempre prima con un LFI locale se il target è vulnerabile a questa configurazione, o cerca altre vie (vedi [04-Wrappers-PHP.md](/cheatsheet/ewpt/03-file-inclusion/04-wrappers-php/)).
...
- **Prerequisito:** [02-LFI-Advanced.md](/cheatsheet/ewpt/03-file-inclusion/02-lfi-advanced/)
- **Prossimo Step:** [04-Wrappers-PHP.md](/cheatsheet/ewpt/03-file-inclusion/04-wrappers-php/)
