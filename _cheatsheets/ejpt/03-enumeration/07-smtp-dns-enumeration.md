...
permalink: "/cheatsheet/ejpt/03-enumeration/07-smtp-dns-enumeration/"
section: "Enumeration"
section_order: 3
order: 7
sort_key: 307
...
**Time to Master:** 1h
**Prerequisiti:** [06-NFS-RPC-Enumeration.md](/cheatsheet/ejpt/03-enumeration/06-nfs-rpc-enumeration/)
...
**Spiegazione:** la userlist risultante può essere riusata direttamente per un brute force mirato su SSH/FTP/web login (vedi [../05-System-Host-Attacks/03-Password-Attacks-Hydra-John-Hashcat.md](/cheatsheet/ejpt/05-system-host-attacks/03-password-attacks-hydra-john-hashcat/)).
...
- **Prerequisito:** [06-NFS-RPC-Enumeration.md](/cheatsheet/ejpt/03-enumeration/06-nfs-rpc-enumeration/)
- **Prossimo Step:** [Lab-Challenges.md](/cheatsheet/ejpt/03-enumeration/lab-challenges/)
