...
cert: ejpt
cert_label: "eJPT"
title: "Password Attacks: Hydra, John, Hashcat"
permalink: "/cheatsheet/ejpt/05-system-host-attacks/03-password-attacks-hydra-john-hashcat/"
...
**Time to Master:** 2h
**Prerequisiti:** [../00-Fundamentals/05-Cryptography-Basics.md](/cheatsheet/ejpt/00-fundamentals/05-cryptography-basics/)
...
**Spiegazione:** dopo un dump di hash NTLM (vedi [04-Credential-Dumping-Mimikatz.md](/cheatsheet/ejpt/05-system-host-attacks/04-credential-dumping-mimikatz/)), John prova ogni parola della wordlist contro l'hash fino a trovare match; `--show` visualizza i risultati già craccati.
...
- **Prerequisito:** [../00-Fundamentals/05-Cryptography-Basics.md](/cheatsheet/ejpt/00-fundamentals/05-cryptography-basics/)
- **Prossimo Step:** [04-Credential-Dumping-Mimikatz.md](/cheatsheet/ejpt/05-system-host-attacks/04-credential-dumping-mimikatz/)
- **Combinazione con:** [01-Windows-Host-Attacks.md](/cheatsheet/ejpt/05-system-host-attacks/01-windows-host-attacks/), [02-Linux-Host-Attacks.md](/cheatsheet/ejpt/05-system-host-attacks/02-linux-host-attacks/)
