...
permalink: "/cheatsheet/ejpt/10-web-application-attacks/01-web-fundamentals-http/"
...
**Difficoltà:** Beginner
**Time to Master:** 1.5h
**Prerequisiti:** [../00-Fundamentals/02-Networking-Basics.md](/cheatsheet/ejpt/00-fundamentals/02-networking-basics/)
...
| Burp Suite | proxy intercettivo | request/response completa | vedi [05-Burp-Suite-Basics.md](/cheatsheet/ejpt/10-web-application-attacks/05-burp-suite-basics/) |
...
- **Prerequisito:** [../00-Fundamentals/02-Networking-Basics.md](/cheatsheet/ejpt/00-fundamentals/02-networking-basics/)
- **Prossimo Step:** [02-SQL-Injection-Basics.md](/cheatsheet/ejpt/10-web-application-attacks/02-sql-injection-basics/)
- **Combinazione con:** [05-Burp-Suite-Basics.md](/cheatsheet/ejpt/10-web-application-attacks/05-burp-suite-basics/)
