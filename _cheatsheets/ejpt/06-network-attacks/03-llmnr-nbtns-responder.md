...
cert: ejpt
cert_label: "eJPT"
title: "LLMNR/NBT-NS Poisoning con Responder"
permalink: "/cheatsheet/ejpt/06-network-attacks/03-llmnr-nbtns-responder/"
...
**Time to Master:** 2h
**Prerequisiti:** [02-Sniffing-Wireshark.md](/cheatsheet/ejpt/06-network-attacks/02-sniffing-wireshark/)
...
Se il traffico broadcast non raggiunge la vittima perché sei su una VLAN separata, combina con [01-MITM-ARP-Spoofing.md](/cheatsheet/ejpt/06-network-attacks/01-mitm-arp-spoofing/) per posizionarti sullo stesso segmento. Altrimenti non serve fare nulla di speciale: lascia Responder acceso e attendi, su una rete Windows con molti client è quasi sempre solo questione di tempo.
...
- **Prerequisito:** [02-Sniffing-Wireshark.md](/cheatsheet/ejpt/06-network-attacks/02-sniffing-wireshark/)
- **Prossimo Step:** [04-DNS-Attacks.md](/cheatsheet/ejpt/06-network-attacks/04-dns-attacks/)
