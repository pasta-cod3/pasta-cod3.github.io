...
permalink: "/cheatsheet/ejpt/02-footprinting-scanning/04-service-version-os-detection/"
...
**Difficoltà:** Beginner
**Time to Master:** 1h
**Prerequisiti:** [03-Port-Scanning-Techniques.md](/cheatsheet/ejpt/02-footprinting-scanning/03-port-scanning-techniques/)
...
**Spiegazione:** avere la versione esatta (es. `vsftpd 2.3.4`, noto per una backdoor storica) permette la ricerca mirata di exploit in [08-Exploitation-PostEx/01-Manual-Exploitation-Searchsploit.md](/cheatsheet/ejpt/08-exploitation-postex/01-manual-exploitation-searchsploit/).
...
- **Prerequisito:** [03-Port-Scanning-Techniques.md](/cheatsheet/ejpt/02-footprinting-scanning/03-port-scanning-techniques/)
- **Prossimo Step:** [Lab-Challenges.md](/cheatsheet/ejpt/02-footprinting-scanning/lab-challenges/)
- **Combinazione con:** [../04-Vulnerability-Assessment/02-Nmap-NSE-Scripts.md](/cheatsheet/ejpt/04-vulnerability-assessment/02-nmap-nse-scripts/)
