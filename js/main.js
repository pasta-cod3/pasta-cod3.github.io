...
function catClass(cat) {
  const m = { 'red-team':'c-red','blue-team':'c-blue','storia':'c-storia','fondamentali':'c-fond','notizie':'c-news' };
  return m[cat] || '';
}
...
function updateCounts() {
  ...
  const map = {
    'red-team': ['cnt-red','cc-red'],
    'blue-team': ['cnt-blue','cc-blue'],
    'storia': ['cnt-storia','cc-storia'],
    'fondamentali': ['cnt-fond','cc-fond'],
    'notizie': ['cnt-news','cc-news'],
  };
